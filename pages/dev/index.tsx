import aboutImg from "@/assets/icon_pad.png";
import logo from "@/assets/icon_pad.png";
    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="https://franciscoliveira.com/dev"
        />
      ...
      <main className={styles.main}>
          ...
          <div>
            <nav id="nav" className="row fadeUp">
              ...
              <ul className="list-items">
                <a href="#aboutme">
                  <li className="list-item dev fadeRight">About</li>
                </a>
                <a href="#skills">
                  <li className="list-item dev fadeRight">Skills</li>
                </a>
                <a href="#work">
                  <li className="list-item dev fadeRight">My Work</li>
                </a>
                <a href="#contact">
                  <li className="list-item dev fadeRight">Contact</li>
                </a>
              </ul>
            </nav>
        ...
        <div className="navigation-mobile">
          <ul className={"list-items-mobile" + (menuOpen ? " active" : "")}>
            <a href="#aboutme">
              <li className="list-item dev">About</li>
            </a>
            <a href="#work">
              <li className="list-item dev">My Music</li>
            </a>
            <a href="#contact">
              <li className="list-item dev">Contact</li>
            </a>
            <div
          ...
          <div className="container">
            <div className={styles.heroText + " fadeUp"}>
              ...
              <h2 className={styles.name + " " + styles.secondP}>
                Developer. Designer. More.
              </h2>
              <p className={styles.descriptionP + " fadeLeft"}>
                &quot;Code is the poetry of machines,
                <br />
                and <b>developers are the poets</b>.&quot;
              </p>
              <a href="#aboutme" className="btnDev fadeRight">
          ...
          <div>
            ...
            <div className={styles.aboutRow}>
              <div className={styles.aboutmeText + " fadeRight"}>
                ...
                <p className={styles.aboutmeP}>
                  I&apos;m a young man passionate about technology and
                  innovation. From an early age, I was always curious and
                  interested in how things worked, which led me to experiment
                  with various tools and programming languages.
                </p>
                <p className={styles.aboutmeP}>
                  I am currently studying in high school, while looking for ways
                  to apply my knowledge and skills to create innovative
                  projects. In addition, I do participate in projects related to
                  technology and computer science, which allows me to improve my
                  skills and knowledge.
                </p>
                <p className={styles.aboutmeP}>
                  With some years of experience in the software development
                  field, I have expertise in a few coding languages. I always
                  seek to improve my skills and offer the best in terms of
                  quality and innovation.
                </p>
                <p className={styles.aboutmeP}>
                  Besides being dedicated and committed, I am an entrepreneurial
                  and innovative person. I believe that technology is
                  fundamental for the evolution of society and is always looking
                  for new challenges and opportunities to grow and contribute to
                  the community.
                </p>
              </div>
              <div>
                ...
                <div className={styles.skill + " fadeUp"} key={`skill-${i}`}>
                  <div className={styles.skillIcon}>
                    <Image
                      ...
                      height={64}
                      style={{
                        filter: s.bgColor ? "brightness(0) invert(.75)" : "",
                      }}
                    />
                  </div>
          ...
          <div>
            ...
            <div className={styles.tagsContainer}>
              {tags.map((t: any, i) => (
                <span
                  className={
                    styles.tag + " " + (activeFilter === t ? styles.active : "")
                  }
                  onClick={() => handleWorkFilter(t)}
                  key={`tag-${i}`}
                >
                  <span>{t}</span>
                </span>
              ...
              {filterWork.map((w: any, i) => (
                ...
                >
                  <div
                    ...
                    style={{ backgroundImage: `url(${urlFor(w.imgUrl)})` }}
                  >
