      ...
      <main className={styles.main}>
        ...
        <section id="home" className={styles.home}>
          <div className='container'>
            <div className={styles.heroText + ' fadeUp'}>
              ...
              <p className={styles.descriptionP + " fadeLeft"}>Welcome to my website, where you can find all about me. So take a look around, listen to some of my work, and join me on this musical journey!</p>
        ...
        <section id="music" className="container fadeUp">
          <div>
            ...
            <div className={styles.portfolioContainer}>
              ...
              {
                !loading && music.map((a: any, i) => (
                  <div className={styles.box + " fadeDown"} key={`music-${i}`} onClick={() => window.open(a.url, '_blank')}>
                    <div className={styles.boxImg} style={{ backgroundImage: `url(${a.image})` }}>
        ...
        <section className={styles.socials}>
          ...
          <div>
            ...
            <a href="https://music.apple.com/us/artist/francisco-oliveira/1683345218" target="_blank"><i className="fa-brands fa-itunes"></i></a>
            <a href="https://deezer.page.link/JDBUgujznCLZau6F9" target="_blank"><i className="fa-brands fa-deezer"></i></a>
        ...
        <section id="contact" className={"container fadeUp " + styles.contact}>
          ...
          <a href="https://t.me/olivei_f" target="_blank" className={styles.contactBtn + ' btnMusic'}>Say Hello</a>
        </section >
